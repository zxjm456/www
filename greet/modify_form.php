...
발전하는 모델을 제시하기 위해 노력하고 있습니다.</p>
		...
		<div id="write_form">
			...
			<div id="write_row2"><div class="col1"> 제목   </div>
			                     <div class="col2"><input type="text" name="subject" value="<?=$item_subject?>" placeholder="제목을 입력해주세요" ></div>
			</div>
			<div class="write_line"></div>
			<div id="write_row3"><div class="col1"> 내용  <i class="fas fa-calendar" style="float: right; margin-top: 3px;"></i> </div>
			                     <div class="col2"><textarea rows="15" cols="79" name="content"><?=$item_content?></textarea></div>
			</div>
			<div class="write_line"></div>
		</div>

		<div id="write_button"><input type="submit" vlaue="확인">&nbsp;

		...
		<div id="login_form">
			 ...
			 <div id="login2">
				<div id="id_input_button">
					<fieldset>
                        <input type="text" name="name" class="find_input find_name" placeholder="이름을 입력해주세여">
                        <input type="text" name="id" class="find_input find_id" placeholder="아이디를 입력해주세여">
                        <div class="telBox">
                            ...
                            <input class="find_input" type="text" id="hp2" name="hp2" title="연락처 가운데3자리를 입력하세요." maxlength="4" placeholder="번호 4자리를 입력해주세요" required> ㅡ
                            <label class="hidden" for="hp3">연락처 마지막3자리</label>
                            <input class="find_input" type="text" id="hp3" name="hp3" title="연락처 마지막3자리를 입력하세요." maxlength="4" placeholder="번호 4자리를 입력해주세요" required>
                        </div>
                        <div class="go">
